...
const location=useLocation()
  ...
  const goToNextVideo=()=>{
    ...
    if(currentSubSectionIndx !== noOfSubsections-1){
      //same section ki next video me jaana hai
      ...
      const nextSectionId=courseSectionData[currentSectionIndx+1];
  ...
  const goToPrevVideo=()=>{
    ...
    if(currentSubSectionIndx !==0){
      ...
      //prev section ke last video pr jao
...
//is video pr jao
  ...
  // For manipulating objet in DOM we need useRef
  return (
